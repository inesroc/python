from auxTarefas import readFunc, writeFunc, consultFunc, removeFunc, addTarefa, closeTarefa, estadoTarefa, editTarefa, searchTarefa, sortTarefa, readNomeListas, getListas, atualiza, mudarNomeLista, mudarLista, criarList
import os
