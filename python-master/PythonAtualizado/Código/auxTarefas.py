...
def closeTarefa(list.lista):  #mudar list para list.lista - acabado
    temp = []
    sel = 1
...
def estadoTarefa(list.lista):  #mudar list para list.lista-acabado
...
def editTarefa(list.lista): #mudar list para list.lista - acabado
    sel = 1
    ...
    if op == 2:
        ...
        list.lista[sel][4] = input()

def searchTarefa(list.lista): #mudar list para list.lista - acabado
    print("Digite:")
...
def sortTarefa(list.lista): #mudar list para list.lista - acabado
    campo = 0
