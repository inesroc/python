from auxCompras import read, write, readCate, writeCate, writeInventario, readInventario, writeCateItem, readCateItem, addCompras, editarElem, remove, searchElem, visualizar, editarCate, closeElem
